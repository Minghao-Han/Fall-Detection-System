...
static hbDNNInferCtrlParam *infer_ctrl_param;
static hbDNNHandle_t dnn_handle;
static frame_buf_t frame_buf;

void inference_init(hbDNNInferCtrlParam *infer_ctrl_param1,char *model_path){
    infer_ctrl_param=infer_ctrl_param1;
    // model init 模型初始化
    // 第一步加载模型
