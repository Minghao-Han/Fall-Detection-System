...
public class Message {
    //1min只能发一条
    private static String accessKeyId, accessKeySecret, signName, templateCode;
    static {
        accessKeyId = "LTAI5tCPUAEHxZxKnK3Q5FWw";
        accessKeySecret = "SDTbc9EzOGtOZLrNoOLRstmsChA51u";
        signName = "阿里云短信测试";
